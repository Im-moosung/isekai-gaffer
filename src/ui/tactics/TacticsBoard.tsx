 ...
 *
 *  ★ 2026-08-02: 스코어버그 옆 상시 배지(PlanBadge의 '플랜 유지 · 팀 이해도 +3%')를
 *  없애면서, **보너스 수치를 알리는 자리는 여기 하나로** 남겼다. 방송 화면의 배지는
 *  유저가 부르지 않았는데 90분 내내 같은 말을 반복했지만, 이 패널은 유저가 작전판을
 *  열어 "내 플랜에서 얼마나 벗어났나"를 물었을 때의 답이다 — 같은 문장이라도 물음에
 *  대한 답은 노이즈가 아니다. 그래서 여기서만 +3%를 말한다. */
