...
//
// ★ 사기 칩(🔥/😰)이 여기 없는 것은 **누락이 아니라 판단**이다(2026-08-01).
//   3D는 playing에서만 뜨고 그때는 개입 등급이 'none'이라 칩을 봐도 할 수 있는 일이 없고,
//   사기는 골과 함께 즉시 움직여 안무보다 먼저 결과를 흘린다(예지력 누설).
//   근거 전문: docs/superpowers/specs/2026-08-01-3d-nameplate-morale.md
//
// ─────────────────────────────────────────────────────────────────────────────
