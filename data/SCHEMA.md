...
```jsonc
{
  ...
  "fifaRanking": 23,                // 대회 개막 시점 FIFA 랭킹 (2026년 6월 발표분, 🟢 교차확인 값만)
  "tier": 3,                        // 게임 난이도 티어 1(우승권)~4 — fifaRanking + 대회 성적 근거로 산정
...
- `fifaRanking`은 **대회 개막 시점(2026년 6월 발표분)** 랭킹 — 대회 후 랭킹 사용 금지 (당시 기준이어야 "그날로 돌아간" 서사와 일관)
- 용도 ①: 난이도 티어 산정 근거 (랭킹 + 실제 대회 성적 종합)
- 용도 ②: **업셋 보너스** — 리더보드 점수에서 `랭킹 차이 × 라운드 가중치`로 강팀 격파 보너스 산출 (한국이 스페인을 꺾으면 최대 보너스)
- 용도 ③: 워룸 상대 리포트·방송 그래픽에 노출 ("FIFA 랭킹 3위 스페인")
